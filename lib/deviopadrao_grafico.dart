...
class DesvioGraficoPage extends StatefulWidget {
  ...
  @override
  _DesvioGraficoPageState createState() => _DesvioGraficoPageState(desvioevent: desvioevent,desvio:desvio,periodo:periodo,stocks:stocks,stockname:stockname);
}
...
DateTime getinterval(){
  ...
  List<Stock> generateData() {
    ...
    Stock eventstock = stocks.where((e) => e.datetime == desvioevent.stock.datetime).single;
          ...
          child: SfCartesianChart(
            ...
            annotations: <CartesianChartAnnotation>[
                  CartesianChartAnnotation(
                    widget: Container(child: const Text('Evento',style: TextStyle(color: AppColors.white),)),
