                          ...
                          children: [
                            Column(
                              children: e
                                  ...
                                  .map(
                                    (element) {
                                      int indexofI = buysignals[indexofB].indicadoresopcoes.indexOf(element);
                                      ...
                                      return Card(
                                        ...
                                        child: ListTile(
                                          leading:
                                            ...
                                            color: Colors.blue,
                                            onPressed: () => _openPopUp(buysignals[indexofB].indicadoresopcoes[indexofI]) ,
                                          ),
                                          trailing:
                                              IconButton(
                                            padding: EdgeInsets.all(0),
                                            ...
                                            color: Colors.grey,
                                            onPressed: () => _deleteItemMultiBuySignals(e, element),
                                          ),
                                          title:
                                              Text(
                                            element.name,
                          ...
                          children: [
                            Column(
                              children: e
                                  ...
                                  .map(
                                    (element) {
                                      int indexofI = sellsignals[indexofB].indicadoresopcoes.indexOf(element);
                                      return Card(
                                        elevation: 5,
                                        child: ListTile(
                                          leading:
                                            ...
                                            icon: Icon(Icons.settings),
                                            color: Colors.blue,
                                            onPressed: () => _openPopUp(sellsignals[indexofB].indicadoresopcoes[indexofI]),
                                          ),
                                          trailing:
                                              IconButton(
                                            padding: EdgeInsets.all(0),
                                            icon: Icon(Icons.delete),
                                            color: Colors.grey,
                                            onPressed: () => _deleteItemMultiSellSignals(e, element),
                                          ),
                                          title:
                                              Text(
                                            element.name,
