...
class PivotPointGraficoPage extends StatefulWidget {
  ...
  @override
  _PivotPointGraficoPageState createState() => _PivotPointGraficoPageState(stocks:stocks,stockname:stockname,pivotevent:pivotevent,pivotpoint:pivotpoint);
}
...
double getmin(List<Stock> candles){
    ...
    List<int> values = candles
          .map((Stock candle){ return (candle.low).toInt(); })
          .toList();
...
double getmax(List<Stock> candles){
    ...
    List<int> values = candles
          .map((Stock candle){ return (candle.high).round(); })
          .toList();
...
DateTime getinterval(){
  ...
  double intervalo = data.last.datetime.difference(data[0].datetime).inDays / 2;
            ...
            annotations: <CartesianChartAnnotation>[
                   ...
                   CartesianChartAnnotation(
                    widget: Container(
                      ...
                      child:  Text('R3',style: TextStyle(color: Colors.red[300]),)),
                  ...
                  CartesianChartAnnotation(
                    widget: Container(
                      padding: EdgeInsets.only(right:0),
                      child:  Text('R2',style: TextStyle(color: Colors.red[200]),)),
                    coordinateUnit: CoordinateUnit.point,
                    x: pivotevent.stock.datetime,
                  ...
                  CartesianChartAnnotation(
                    widget: Container(
                      padding: EdgeInsets.only(right:0),
                      child:  Text('R1',style: TextStyle(color: Colors.red[100]),)),
                    coordinateUnit: CoordinateUnit.point,
                    x: pivotevent.stock.datetime,
                  ...
                  CartesianChartAnnotation(
                    widget: Container(
                      padding: EdgeInsets.only(right:0),
                      child:  Text('S1',style: TextStyle(color: Colors.blue[100]),)),
                    coordinateUnit: CoordinateUnit.point,
                    x: pivotevent.stock.datetime,
                  ...
                  CartesianChartAnnotation(
                    widget: Container(
                      padding: EdgeInsets.only(right:0),
                      child:  Text('S2',style: TextStyle(color: Colors.blue[200]),)),
                    coordinateUnit: CoordinateUnit.point,
                    x: pivotevent.stock.datetime,
                  ...
                  CartesianChartAnnotation(
                    widget: Container(
                      padding: EdgeInsets.only(right:0),
                      child:  Text('S3',style: TextStyle(color: Colors.blue[300]),)),
                    coordinateUnit: CoordinateUnit.point,
                    x: pivotevent.stock.datetime,
