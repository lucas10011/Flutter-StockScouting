...
class LogicaBackTesting {
  ...
  static bool verificaocondicao(IndicadoresOpcao indicadoropcao, num index,
      List<Stock> stocks, MapIndicadores map, Stock tradeEntrada, int indexEntrada) {
    ...
    switch (indicadoropcao.id) {
            ...
            switch (indicadoropcao.configselecionado.id) {
              ...
              case "acudis1":
                if(index - 1 > sequencia){
                  ...
                  for (num i = 0; i < sequencia; i++) {
                    ...
                    if (mapAcumDist[key][start + i].y > mapAcumDist[key][(start + i) - 1].y) {
              ...
              case "acudis5":
                ...
                if(index > periodo){
                  ...
                  return (comparacaovalores(valor4, valor2) && comparacaovalores(valor1, valor3) );
                }else{
                  return false;
                }
              ...
              case "acudis6":
               String keymodified = "$id:$periodo:media";
                ...
                if(index > periodo){
                  ...
                  return (comparacaovalores(valor2, valor4) && comparacaovalores(valor3, valor1) );
                }else{
                  return false;
                }
      ...
      case 3:
        {
          ...
          if (index - 1 > periodo) {
            ...
            BollingerPointData bollingerpointanterior = mapBollinger[key][index - 1];
            ...
            switch (indicadoropcao.configselecionado.id) {
              ...
              case "ema3":
                ...
                for (num i = 0; i < sequencia; i++) {
                  ...
                  if (mapEma[key][start + i].y > mapEma[key][(start + i) - 1].y) {
                    booleansverify.add(true);
                  } else {
                    booleansverify.add(false);
                  }
      ...
      case 5:
        {
          ...
          if ((index - 1) > len) {
            // print("index:${index - indicadoropcao.parametro["periodolento"]  }");
            // print("total:${mapMacd[periodo]["macdCollection"].length}");
            DataPoint macdCollection =
                mapMacd[key]["macdCollection"][index];
            ...
            switch (indicadoropcao.configselecionado.id) {
              ...
              case "macd5":
                ...
                for (num i = 0; i <= sequencia; i++) {  
                      ...
                      DataPoint macdPoint = mapMacd[key]["macdCollection"][start + i];
                      DataPoint signalPoint= mapMacd[key]["signalCollection"][start + i];
                      DataPoint histogramPoint = mapMacd[key]["histogramCollection"][start + i];

                      DataPoint histogramPoint1 = mapMacd[key]["histogramCollection"][(start + i) - 1];               

                  if(i != sequencia){

                    if (macdPoint.y > 0 && signalPoint.y > 0 && histogramPoint.y > 0) {
                        booleansverify.add(true);
                    } else {
                      booleansverify.add(false);
                    }
                ...
                if (countbooleanbuy == 0) {
                  //  for (num i = 0; i <= sequencia; i++) {
                  //    print("MacdPoint:${mapMacd[key]["macdCollection"][start + i].y}/////signalPoint:${mapMacd[key]["signalCollection"][start + i].y}/////histogramPoint:${mapMacd[key]["histogramCollection"][start + i].y}");
                  //  }
                  //  print("//////////////////");
                  return true;
                } else {
              ...
              /////Histogram sequencia de alta
                if((index > len + sequencia) ){
                    ...
                    if (countbooleanbuy == 0) {
                      // for (num i = 0; i <= sequencia; i++) {
                      // print("histogramPoint:${mapMacd[key]["histogramCollection"][start + i].y}");
                      // }
                      //   print("//////////////////");
                      return true;
                    } else {
              ...
              /////Histogram sequencia de queda
                if((index > len + sequencia) ){
                    ...
                    if (countbooleanbuy == 0) {
                      // for (num i = 0; i <= sequencia; i++) {
                      // print("histogramCollection:${mapMacd[key]["histogramCollection"][start + i].y}");
                      // }
                      //   print("//////////////////");
                      return true;
                    } else {
              ...
              /////Histogram sequencia de alta acima de 0
                if((index > len + sequencia) ){
                    ...
                    for (num i = 0; i < sequencia; i++) { 
                      ...
                      if(histogramPoint.y > histogramPoint1.y && histogramPoint.y > 0) {
                          booleansverify.add(true);
                        } else {
                          booleansverify.add(false);
                        }
            ...
            switch (indicadoropcao.configselecionado.id) {
              ...
              case "media3":
                ...
                for (num i = 0; i < sequencia; i++) {
                  ...
                  if (mapSma[key][start + i].y > mapSma[key][(start + i) - 1].y) {
                    booleansverify.add(true);
                  } else {
                    booleansverify.add(false);
                  }
      ...
      case 9:
        {
          ...
          if (index - 1 > periodo) {
            ...
            DataPoint datapointanterior =  mapStochastic[key]["periodCollection"][index - 1];
            ...
            switch (indicadoropcao.configselecionado.id) {
              ...
              case "stochastic7":
                if( index  > (periodo + sequencia)){
                 ...
                 /////Sobrecomprado ha (n) periodos
                  ...
                  int start = index - sequencia;
                  for (num i = 0; i < sequencia; i++) {
                   DataPoint stochasticpoint = mapStochastic[key]["periodCollection"][start + i];  
              ...
              DataPoint signalpoint = mapStochastic[key]["signalCollection"][index];
              DataPoint signalpointanterior =  mapStochastic[key]["signalCollection"][index - 1];
              num valor1 = datapoint.y;
             ...
             case 'candle11':
              {
               ...
               return (comparacaovalores(valor2, valor3) && comparacaovalores(valor1, valor2));
               }else{
                 return false;
               }
              }
             ...
             case 'candle12':
              {
                ...
                return (comparacaovalores(valor3, valor2) && comparacaovalores(valor2, valor1));
                }else{
                  return false;
                }
              }
      ...
      case 11:
        ...
        case 12:
        {
            ...
            num id = indicadoropcao.id;
            num c_Len = indicadoropcao.parametro['periodo']; // ema depth for bodyAvg
            ...
            case "cpattern1":
              {            
                ...
                if(index - 1 > c_Len ){
                  ...
                  Map candle = FunctionStock.candleInfo(stocks, index, emabodyvalue,c_Len);
                  Map candle1 = FunctionStock.candleInfo(stocks, index - 1, emabodyanterior,c_Len);
                  ...
                  var c_EngulfingBearish =  candle["c_BlackBody"] && candle["c_LongBody"] && candle1["c_WhiteBody"] && candle1["c_SmallBody"] && candle["close"] <= candle1["open"] && candle["open"] >= candle1["close"] && ( candle["close"] < candle1["open"] || candle["open"] > candle1["close"] );
              ...
              { 
                ...
                if(index - 1 > c_Len ){
                  ...
                  var c_EngulfingBullish =  candle["c_WhiteBody"] && candle["c_LongBody"] && candle1["c_BlackBody"] && candle1["c_SmallBody"] && candle["close"] >= candle1["open"] && candle["open"] <= candle1["close"] && ( candle["close"] > candle1["open"] || candle["open"] < candle1["close"] );
              ...
              { 
                ...
                if(index - 2 > c_Len ){
                  ...
                  Map candle = FunctionStock.candleInfo(stocks, index, emabodyvalue,c_Len);
                  Map candle1 = FunctionStock.candleInfo(stocks, index - 1, emabodyvalue1,c_Len);
                  Map candle2 = FunctionStock.candleInfo(stocks, index - 2, emabodyvalue2,c_Len);
                  //c_AbandonedBabyBearish = C_WhiteBody[2] and C_IsDojiBody[1] and high[2] < low[1] and C_BlackBody and low[1] > high

                  var c_AbandonedBabyBearish =  candle2["c_WhiteBody"] && candle1["c_IsDojiBody"] && candle2["high"] < candle1["low"] && candle["c_BlackBody"] && candle1["low"] > candle["high"]; 
              ...
              { 
                ...
                if(index - 2 > c_Len ){
                  ...
                  var c_AbandonedBabyBullish =  candle2["c_BlackBody"] && candle1["c_IsDojiBody"] && candle2["low"] > candle1["high"] && candle["c_WhiteBody"] && candle1["high"] > candle["low"]; 
              ...
              { 
                if(index - 1 > c_Len ){
                  ...
                  var c_DojiStarBearish = candle1["c_WhiteBody"] && candle1["c_LongBody"] && candle["c_IsDojiBody"] && candle["c_BodyLo"] > candle1["c_BodyHi"]; 
              ...
              { 
                 if(index - 1 > c_Len ){
                  ...
                  var c_DojiStarBullish = candle1["c_BlackBody"] && candle1["c_LongBody"] && candle["c_IsDojiBody"] && candle["c_BodyHi"] < candle1["c_BodyLo"]; 
              ...
              { 
                if(index > c_Len ){
                  ...
                  var c_DragonflyDojiBullish = candle["c_IsDojiBody"] && candle["c_UpShadow"] <= candle["c_Body"];
              ...
              { 
                ...
                if(index - 2 > c_Len ){
                  ...
                  var c_EveningDojiStarBearish =  candle2["c_LongBody"] && candle1["c_IsDojiBody"] && candle["c_LongBody"] && candle2["c_WhiteBody"] && candle1["c_BodyLo"] > candle2["c_BodyHi"] && candle["c_BlackBody"] && candle["c_BodyLo"] <= candle2["c_BodyMiddle"] && candle["c_BodyLo"] > candle2["c_BodyLo"] && candle1["c_BodyLo"] > candle["c_BodyHi"];
              ...
              { 
                if(index - 2 > c_Len ){
                  ...
                  if(candle2["c_LongBody"] && candle1["c_SmallBody"] && candle["c_LongBody"]){
                    var c_EveningStarBearish = candle2["c_WhiteBody"] && candle1["c_BodyLo"] > candle2["c_BodyHi"] && candle["c_BlackBody"] && candle["c_BodyLo"] <= candle2["c_BodyMiddle"] && candle["c_BodyLo"] > candle2["c_BodyLo"] && candle1["c_BodyLo"] > candle["c_BodyHi"]; 
              ...
              { 
                if(index - 4 > c_Len ){
                  ...
                  Map candle1 = FunctionStock.candleInfo(stocks, index - 1, emabodyvalue1,c_Len);
                  Map candle2 = FunctionStock.candleInfo(stocks, index - 2, emabodyvalue2,c_Len);
                  Map candle3 = FunctionStock.candleInfo(stocks, index - 3, emabodyvalue3,c_Len);
                  Map candle4 = FunctionStock.candleInfo(stocks, index - 4, emabodyvalue4,c_Len);
                  ...
                  var c_FallingThreeMethodsBearish = (candle4["c_LongBody"] && candle4["c_BlackBody"]) && (candle3["c_SmallBody"] && candle3["c_WhiteBody"] && candle3["open"] > candle4["low"] && candle3["close"] < candle4["high"]) && (candle2["c_SmallBody"] && candle2["c_WhiteBody"] && candle2["open"] > candle4["low"] && candle2["close"] < candle4["high"]) &&  (candle1["c_SmallBody"] && candle1["c_WhiteBody"] && candle1["open"] > candle4["low"] && candle1["close"] < candle4["high"]) && (candle["c_LongBody"] && candle["c_BlackBody"] && candle["close"] < candle4["close"]);
              ...
              { 
                if(index > c_Len ){
                 ...
                 // C_IsDojiBody and C_DnShadow <= C_Body
                  var c_GravestoneDojiBearish = candle["c_IsDojiBody"] && candle["c_DnShadow"] <= candle["c_Body"];
              ...
              { 
                if(index > c_Len ){
                 ...
                 // if C_SmallBody and C_Body > 0 and C_BodyLo > hl2 and C_DnShadow >= C_Factor * C_Body and not C_HasUpShadow
                  var c_HammerBullish = candle["c_SmallBody"] && candle["c_Body"] > 0 && candle["c_BodyLo"] > hl2 && candle["c_DnShadow"] >= candle["c_Factor"] * candle["c_Body"] && !candle["c_HasUpShadow"];  
              ...
              { 
                if(index > c_Len ){
                 ...
                 // C_SmallBody and C_Body > 0 and C_BodyHi < hl2 and C_UpShadow >= C_Factor * C_Body and not C_HasDnShadow
                  var c_InvertedHammerBullish = candle["c_SmallBody"] && candle["c_Body"] > 0 && candle["c_BodyHi"] < hl2 && candle["c_UpShadow"] >= candle["c_Factor"] * candle["c_Body"] && !candle["c_HasDnShadow"];
              ...
              { 
                if(index > c_Len ){
                 ...
                 // C_SmallBody and C_Body > 0 and C_BodyLo > hl2 and C_DnShadow >= C_Factor * C_Body and not C_HasUpShadow
                  var c_HangingManBearish = candle["c_SmallBody"] && candle["c_Body"] > 0 && candle["c_BodyLo"] > hl2 && candle["c_DnShadow"] >= candle["c_Factor"] * candle["c_Body"] && !candle["c_HasUpShadow"];
              ...
              { 
                if(index > c_Len ){
                 ...
                 // C_BlackBody and C_LongBody and C_UpShadow <= C_MarubozuShadowPercentBearish/100*C_Body and C_DnShadow <= C_MarubozuShadowPercentBearish/100*C_Body and C_BlackBody
                  var c_MarubozuBlackBearish = candle["c_BlackBody"] && candle["c_LongBody"] && candle["c_UpShadow"] <= c_MarubozuShadowPercentBearish/100*candle["c_Body"] && candle["c_DnShadow"] <= c_MarubozuShadowPercentBearish/100*candle["c_Body"] && candle["c_BlackBody"];
              ...
              { 
                if(index > c_Len ){
                 ...
                 // C_MarubozuWhiteBullish = C_WhiteBody and C_LongBody and C_UpShadow <= C_MarubozuShadowPercentWhite/100*C_Body and C_DnShadow <= C_MarubozuShadowPercentWhite/100*C_Body and C_WhiteBody
                  var c_MarubozuWhiteBullish = candle["c_WhiteBody"] && candle["c_LongBody"] && candle["c_UpShadow"] <= c_MarubozuShadowPercentWhite/100*candle["c_Body"] && candle["c_DnShadow"] <= c_MarubozuShadowPercentWhite/100*candle["c_Body"] && candle["c_WhiteBody"];
              ...
              { 
                 if(index - 2 > c_Len ){
                  ...
                  if(candle2["c_LongBody"] && candle1["c_SmallBody"] && candle["c_LongBody"]){
                    var c_MorningStarBullish = candle2["c_BlackBody"] && candle1["c_BodyHi"] < candle2["c_BodyLo"] && candle["c_WhiteBody"] && candle["c_BodyHi"] >= candle2["c_BodyMiddle"] && candle["c_BodyHi"] < candle2["c_BodyHi"] && candle1["c_BodyHi"] < candle["c_BodyLo"];
              ...
              { 
                if(index - 2 > c_Len ){
                  ...
                  var c_MorningDojiStarBullish = candle2["c_LongBody"] && candle1["c_IsDojiBody"] && candle["c_LongBody"] && candle2["c_BlackBody"] && candle1["c_BodyHi"] < candle2["c_BodyLo"] && candle["c_WhiteBody"] && candle["c_BodyHi"] >= candle2["c_BodyMiddle"] && candle["c_BodyHi"] < candle2["c_BodyHi"] && candle1["c_BodyHi"] < candle["c_BodyLo"];
              ...
              { 
                if(index - 4 > c_Len ){
                  ...
                  Map candle3 = FunctionStock.candleInfo(stocks, index - 3, emabodyvalue3,c_Len);
                  Map candle4 = FunctionStock.candleInfo(stocks, index - 4, emabodyvalue4,c_Len);
                  //if                              (C_LongBody[4] and C_WhiteBody[4])                and (C_SmallBody[3] and C_BlackBody[3] and open[3]<high[4] and close[3]>low[4])                                                 and (C_SmallBody[2] and C_BlackBody[2] and open[2]<high[4] and close[2]>low[4])                                                    and (C_SmallBody[1] and C_BlackBody[1] and open[1]<high[4] and close[1]>low[4])                                               and (C_LongBody and C_WhiteBody and close>close[4])


                  var c_RisingThreeMethodsBullish = (candle4["c_LongBody"] && candle4["c_WhiteBody"]) && (candle3["c_SmallBody"] && candle3["c_BlackBody"] && candle3["open"] < candle4["high"] && candle3["close"] > candle4["low"]) &&  (candle2["c_SmallBody"] && candle2["c_BlackBody"] && candle2["open"] < candle4["high"] && candle2["close"] > candle4["low"]) && (candle1["c_SmallBody"] && candle1["c_BlackBody"] && candle1["open"] < candle4["high"] && candle1["close"] > candle4["low"]) && (candle["c_LongBody"] && candle["c_WhiteBody"] && candle["close"] > candle4["close"]); 
              ...
              { 
                if(index > c_Len ){
                 ...
                 //                           C_SmallBody and C_Body > 0 and C_BodyHi < hl2 and C_UpShadow >= C_Factor * C_Body and not C_HasDnShadow
                  var c_ShootingStarBearish = candle["c_SmallBody"] && candle["c_Body"] > 0 && candle["c_BodyHi"] < hl2 && candle["c_UpShadow"] >= candle["c_Factor"] * candle["c_Body"] && !candle["c_HasDnShadow"];
              ...
              { 
                if(index - 2 > c_Len ){
                  ...
                  var c_3WSld_HaveNotUpShadow = candle["c_Range"] * c_3WSld_ShadowPercent / 100 > candle["c_UpShadow"];
                  var c_3WSld_HaveNotUpShadow1 = candle1["c_Range"] * c_3WSld_ShadowPercent / 100 > candle1["c_UpShadow"];
                  var c_3WSld_HaveNotUpShadow2 = candle2["c_Range"] * c_3WSld_ShadowPercent / 100 > candle2["c_UpShadow"];
                  ...
                  if(candle["c_LongBody"] && candle1["c_LongBody"] && candle2["c_LongBody"]){
                    if(candle["c_WhiteBody"] && candle1["c_WhiteBody"] && candle2["c_WhiteBody"]){
                      var c_ThreeWhiteSoldiersBullish =  candle["close"] > candle1["close"] && candle1["close"] > candle2["close"] && candle["open"] < candle1["close"] && candle["open"] > candle1["open"] && candle1["open"] < candle2["close"] && candle1["open"] > candle2["open"] && c_3WSld_HaveNotUpShadow && c_3WSld_HaveNotUpShadow1 && c_3WSld_HaveNotUpShadow2;
              ...
              { 
                if(index - 2 > c_Len ){
                  ...
                  var c_3WSld_ShadowPercent = 5.0;
                  var c_3BCrw_HaveNotDnShadow = candle["c_Range"] * c_3WSld_ShadowPercent / 100 > candle["c_DnShadow"];
                  var c_3BCrw_HaveNotDnShadow1 = candle1["c_Range"] * c_3WSld_ShadowPercent / 100 > candle1["c_DnShadow"];
                  var c_3BCrw_HaveNotDnShadow2 = candle2["c_Range"] * c_3WSld_ShadowPercent / 100 > candle2["c_DnShadow"];

                  //if  C_LongBody and C_LongBody[1] and C_LongBody[2]
                    ///if C_BlackBody and C_BlackBody[1] and C_BlackBody[2]
                         /// close < close[1] and close[1] < close[2] and open > close[1] and open < open[1] and open[1] > close[2] and open[1] < open[2] and C_3BCrw_HaveNotDnShadow and C_3BCrw_HaveNotDnShadow[1] and C_3BCrw_HaveNotDnShadow[2]
                  
                  if(candle["c_LongBody"] && candle1["c_LongBody"] && candle2["c_LongBody"]){
                    if(candle["c_BlackBody"] && candle1["c_BlackBody"] && candle2["c_BlackBody"]){
                      var c_ThreeBlackCrowsBearish =  candle["close"] < candle1["close"] && candle1["close"] < candle2["close"] && candle["open"] > candle1["close"] && candle["open"] < candle1["open"] && candle1["open"] > candle2["close"] && candle1["open"] < candle2["open"] && c_3BCrw_HaveNotDnShadow && c_3BCrw_HaveNotDnShadow1 && c_3BCrw_HaveNotDnShadow2;
              ...
              { 
                if(index - 2 > c_Len ){
                  ...
                  var c_TweezerBottomBullish =  (!candle["c_IsDojiBody"] || (candle["c_HasUpShadow"] && candle["c_HasDnShadow"])) && (candle["low"] - candle1["low"]).abs() <= candle["c_BodyAvg"] * 0.05 && candle1["c_BlackBody"] && candle["c_WhiteBody"] && candle1["c_LongBody"];
              ...
              { 
                if(index - 2 > c_Len ){
                  ...
                  Map candle1 = FunctionStock.candleInfo(stocks, index - 1, emabodyvalue1,c_Len);
                  Map candle2 = FunctionStock.candleInfo(stocks, index - 2, emabodyvalue2,c_Len);
                  //if (not C_IsDojiBody or (C_HasUpShadow and C_HasDnShadow)) and abs(high-high[1]) <= C_BodyAvg*0.05 and C_WhiteBody[1] and C_BlackBody and C_LongBody[1]

                  var c_TweezerTopBearish =  (!candle["c_IsDojiBody"] || (candle["c_HasUpShadow"] && candle["c_HasDnShadow"])) && (candle["high"] - candle1["high"]).abs() <= candle["c_BodyAvg"] * 0.05 && candle1["c_WhiteBody"] && candle["c_BlackBody"] && candle1["c_LongBody"];
        ...
        case 13:
        {
          ...
          indicadoropcao.indicadoresopcoes.forEach((indicadoropcaosingle) {
            ...
            condicaoboolean.add(LogicaBackTesting.verificaocondicao(
                indicadoropcaosingle, index, stocks, map, tradeEntrada, indexEntrada));
          });

          int countbooleansell = condicaoboolean.where((item) => item == true).length;
        ...
        case 14:
        {
          ...
          switch (indicadoropcao.configselecionado.id) {
            ...
            case "saida3":
            {
             ...
             //% porcentagem de gain
             num porcentagem = ((stocks[index].close - tradeEntrada.close) / tradeEntrada.close) * 100;
