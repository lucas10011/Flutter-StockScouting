...
class StockPage extends StatefulWidget {
  ...
  @override
  _StockPageState createState() => _StockPageState(stockname: stockname, assetsPath:assetsPath);
}
...
class _StockPageState extends State<StockPage>  with SingleTickerProviderStateMixin{
  ...
  Widget build(BuildContext context) {
    return Scaffold(
            ...
            ?  SafeArea(child: Center(child: Padding(padding: const EdgeInsets.all(16.0),child:AnimatedSwitcher(duration: Duration(milliseconds: 250),child: _widgetOptions.elementAt(_selectedIndex),),)))
           ...
           bottomNavigationBar: CurvedNavigationBar(
              ...
              Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                Icon(Icons.add_chart,size: 30,color: AppColors.white,),
                Text('Estratégia',style: TextStyle(color: AppColors.white,fontSize: 10),)
              ],),
              ...
              //   Text('Desvio',style: TextStyle(color: AppColors.white,fontSize: 10),)
              // ],),
              Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                Icon(Icons.bar_chart,size: 30,color: AppColors.white,),
                Text('Pivot',style: TextStyle(color: AppColors.white,fontSize: 10),)
              ],),
              //  Column(
              //   mainAxisAlignment: MainAxisAlignment.center,
              //   children: [
              //   Icon(Icons.bar_chart,size: 30,color: AppColors.white,),
              //   Text('Tendência',style: TextStyle(color: AppColors.white,fontSize: 10),)
              // ],),
              //  Column(
              //   mainAxisAlignment: MainAxisAlignment.center,
              //   children: [
              //   Icon(Icons.bar_chart,size: 30,color: AppColors.white,),
              //   Text('Força',style: TextStyle(color: AppColors.white,fontSize: 10),)
              // ],),
               Column(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                Icon(Icons.bar_chart,size: 30,color: AppColors.white,),
                Text('Variação',style: TextStyle(color: AppColors.white,fontSize: 10),)
              ],),
              ],
              onTap: _onItemTapped,
            ),
