...
//  MesDataSource _mesDataSource = MesDataSource();
...
class _VariacaoPageState extends State<VariacaoPage> {
  ...
  // Widget _buildTableCedulaMeses(value) {
  //   if (value == '') {
  //     double widthdivision = MediaQuery.of(context).size.width/8;
  //     double heigth = MediaQuery.of(context).size.height/30;
  //     return Container(
  //       padding: EdgeInsets.all(5),
  //       width: widthdivision,
  ...
  //     );
  //   } else {
  //     double widthdivision = MediaQuery.of(context).size.width/12;
  //     double heigth = MediaQuery.of(context).size.height/30;
  //     return Container(
  //       width: widthdivision,
  //       height: heigth,
  ...
  Widget _buildTable(BuildContext context) {
    ...
    // List<Widget> childrenTr =
    //     mesestable.map((e) => _buildTableCedulaMeses(e)).toList();
    ...
    return Padding(
      ...
      child: Container(
        child: Column(children: childrenTable)),
    );}
...
// class MesDataSource extends DataGridSource<MesesVariacao> {
//   @override
//   List<MesesVariacao> get dataSource => _mesesvariacaoselected;

//   @override
//   getValue(MesesVariacao mes, String columnName) {
//     switch (columnName) {
//       case 'jan':
//         return mes.jan;
//         break;
