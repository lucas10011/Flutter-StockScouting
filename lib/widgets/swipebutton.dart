  ...
  Widget build(BuildContext context) {
    return SwipeButton(
              thumb: Row(
                ...
                children: <Widget>[
                  Align(widthFactor: 0.33, child: Icon(Icons.chevron_right,color: Colors.white,)),
                  Align(widthFactor: 0.33, child: Icon(Icons.chevron_right,color: Colors.white)),
                  Align(widthFactor: 0.33, child: Icon(Icons.chevron_right,color: Colors.white)),
                ],
              ),
              content: Center(
                child: Text('Deslize para retirar a tendência',style: TextStyle(color: Colors.white),),
              ),
              onChanged: (result) {
                function(result);
          ...
          DecoratedBox(
            decoration: BoxDecoration(
              gradient: LinearGradient(
                ...
                colors: [Colors.blue[800], Color.fromRGBO(0, 29, 45, 1)]),
          ...
          AnimatedBuilder(
            ...
            child: GestureDetector(
              ...
              child: Container(
                ...
                height: widget.height,
                decoration: BoxDecoration(
                  color: Color.fromRGBO(0, 29, 45, 1),
                  borderRadius: widget.borderRadius,
                ),
                child: widget.thumb,
              ),
